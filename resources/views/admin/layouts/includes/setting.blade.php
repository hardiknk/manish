    ...
    @case('file')
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9 col-xl-6">
                ...
                <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url({{ asset($setting->value) }})">
                    <div class="image-input-wrapper" style="background-image:url({{ asset($setting->value) }})"></div>
