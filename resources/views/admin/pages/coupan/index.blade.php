...
@push('breadcrumb')
    {!! Breadcrumbs::render('coupan_list') !!}
@endpush
...
@section('content')
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    @if (in_array('delete', $permissions))
                        <a href="{{ route('admin.coupans.destroy', 0) }}" name="del_select" id="del_select"
            ...
            <div class="card-body">
                {{--  Datatable Start  --}}
                <table class="table table-bordered table-hover table-checkable" id="coupan_table"
    ...
    <script>
        ...
        oTable = table.dataTable({
            ...
            "ajax": {
                ...
                "url": "{{ route('admin.coupans.listing') }}", // ajax source
            },
