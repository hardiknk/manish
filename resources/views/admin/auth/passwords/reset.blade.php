                ...
                <div class="login-signin">
                    ...
                    <form class="form-horizontal" id="resetpwdForm" role="form" method="POST" action="{{ url('/admin/password/reset') }}" class="form">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                <input id="email" type="email" class="form-control h-auto py-4 px-8 bg-secondary" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" readonly placeholder="Email" autofocus>
                                @if ($errors->has('email'))
