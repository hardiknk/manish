...
//Coupan Breadcome -------------------------------------------
Breadcrumbs::register('coupan_list', function ($breadcrumbs) {
	$breadcrumbs->parent('dashboard');
	$breadcrumbs->push(__('Coupan'), route('admin.coupans.index'));
});
Breadcrumbs::register('coupan_create', function ($breadcrumbs) {
	$breadcrumbs->parent('coupan_list');
	$breadcrumbs->push('Add New Coupan', route('admin.coupans.create'));
});
Breadcrumbs::register('coupan_update', function ($breadcrumbs, $id) {
	$breadcrumbs->parent('coupan_list');
	$breadcrumbs->push(__('Edit Coupan'), route('admin.coupans.edit', $id));
});